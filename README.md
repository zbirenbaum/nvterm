...
local mappings = {
  { 'n', '<C-l>', function () require(terminal).send(ft_cmds[vim.bo.filetype]) end },
  { toggle_modes, '<A-h>', function () require(terminal).toggle('horizontal') end },
  { toggle_modes, '<A-v>', function () require(terminal).toggle('vertical') end },
  { toggle_modes, '<A-i>', function () require(terminal).toggle('float') end },
}
